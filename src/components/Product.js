...
const Product = ({ product }) => {
  ...
  return <div>
    <div className='border border-[#e4e4e4] h-[300px] mb-4 relative overflow-hiden group transition '>
      {/* images */}
      <div className='w-full h-full flex justyfy-center items-center'>
        <div className='w-[200px] mx-auto flex justify-center items-center'>
          <img className='max-h-[160px] group-hover:scale-110 transition doration-300' src={image} alt={title} />
        </div>
